...
class _HomeScreenState extends State<HomeScreen> with TickerProviderStateMixin {
  ...
  StreamSubscription? _emergencyPhraseSubscription;
  ...
  void initState() {
    ...
    _emergencyPhraseSubscription = FlutterBackgroundService().on('emergency_phrase_detected').listen((event) {
  ...
  void dispose() {
    ...
    _emergencyPhraseSubscription?.cancel();
